...
landscape a distribution centered on the stored patterns. Sampling it yields new
profiles rather than copies, because the memory-centered components overlap in
the reduced space}. Because sampling occurs in a principal component analysis
