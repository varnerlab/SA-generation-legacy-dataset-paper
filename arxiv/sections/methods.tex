...
\rboth{The sample-size test asked how performance changed as the clinical training set became
smaller. We drew ten subsets without replacement from the $23$ complete patients at each
$n\in\{20,15,10,8\}$. We constructed a memory matrix from each subset,
...
\rboth{The nonlinearity test asked how increasing curvature affected recovery of a nonlinear
pattern. We drew $t$ uniformly from $[-1,1]$ and defined an S-curve by $x_1=t$ and
