...
sampling. The schemes agree closely in fidelity and in the memorization behavior
relevant to privacy, indicating that the published scheme faithfully represents the
target law at $\beta^*$ (Supplementary Fig.~\ref{sfig:sampling-ladder}).}
