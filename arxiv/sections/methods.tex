...
$x_2=c\sin(\pi t)$. We mapped the curve into $p{=}30$ or~$120$ dimensions with a new random
orthonormal embedding for each replicate and added isotropic Gaussian noise with standard
deviation $0.05$. We used $n{=}23$ and curvature
