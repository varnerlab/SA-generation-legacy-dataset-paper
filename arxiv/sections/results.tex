...
was itself informative. Cloud overlap remained high (0.89--0.93 across the
...
Although fitted only on Visit~1 real patients, the per-visit median ratios under
TF-only conditions remained close to 1.0 at Visits~2 and~3, confirming that
...
real-calibrated model (overall ratio 0.94$\times$;
per-feature breakdown in Table~\ref{stab:downstream-utility}). This improvement likely
