...
stored pattern in angular distance (Table~\ref{stab:beta-sweep}). Second, we computed
...
real and synthetic patients (Fig.~\ref{sfig:mechanistic-tm-combined}), yet this shared systematic bias
...
TF-only conditions were 0.96$\times$ and 1.07$\times$, respectively
(Fig.~\ref{sfig:generalization}), confirming that the calibrated rate constants captured a stable
