...
quality degraded gracefully across $\beta/\beta^* \in [0.1, 3.0]$ (Table~\ref{stab:beta-sweep}). Similarly, varying the PCA variance retention threshold from 85\% to 99\%
...
models~\citep{Ribba2012}, or metabolic
models~\citep{Yizhak2015,Shan2018}), and the requirement is not that the
