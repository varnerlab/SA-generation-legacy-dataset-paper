...
*We agree, and we have made this caveat explicit and quantitative.* At these sizes the conditioned landscapes were severely under-sampled. The participation ratio was 4.6 for the PCOS cohort and 7.7 for Developed PE, so each cohort of 100 generated patients represented a recombination of three and five real individuals, respectively, and in the PCOS case magnitudes were drawn from only three empirical norms. The revised Results stated the consequence directly: those cohorts carried no more information about the conditions than the underlying patients did, and any downstream analysis treating them as 100 independent observations would understate uncertainty. We framed subgroup amplification as supporting exploratory hypothesis generation, workflow testing, and simulation-based power calculations whose uncertainty remained anchored to the original three or five patients. It did not increase the inferential sample size and was not a substitute for recruiting real rare-subgroup patients. The Methods additionally explained that reporting the participation ratio alongside a conditioned cohort stated how much independent material that cohort rested on.
