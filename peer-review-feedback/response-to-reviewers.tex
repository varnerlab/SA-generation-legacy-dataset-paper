...
\subsection{General response to the editor and reviewers}\label{general-response-to-the-editor-and-reviewers}
...
\textbf{Changes:} Methods (PCA-space comparison and Supplementary Methods pointer); Results (Marginal Plausibility); Discussion (representation and sampler distinction); Supplementary Methods (four baseline implementations, placed before the tables and figures); Supplementary Table S13 (five-generator comparison). Blue, with the shared Discussion transition in violet. \texttt{\textbackslash{}rone\{...\}} \texttt{\textbackslash{}rboth\{...\}}
...
\textbf{Changes:} Methods (simplified explanation, connected lead-ins to displayed equations, and a separate concise participation-ratio paragraph); Supplement (detailed theory and calculation). Violet. \texttt{\textbackslash{}rboth\{...\}}
...
\textbf{Changes:} Abstract, Introduction, Discussion, Conclusion wording. \texttt{\textbackslash{}rone\{...\}}
...
As described in \textbf{R1.9}, we moved the detailed theory to the Supplement and added a plain-language explanation to the Methods.
