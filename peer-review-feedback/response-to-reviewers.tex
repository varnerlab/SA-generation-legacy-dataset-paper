...
\textbf{Changes:} Methods (PCA-space comparison and implementation details); Results (Marginal Plausibility); Discussion (representation and sampler distinction); supplementary PCA-space ablation table (five-generator comparison). Blue, with the shared Discussion transition in violet. \texttt{\textbackslash{}rone\{...\}} \texttt{\textbackslash{}rboth\{...\}}
