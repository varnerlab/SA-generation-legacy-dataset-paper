...
markers: real patients (blue = Healthy, $n{=}14$; orange = PCOS, $n{=}3$;
red = PE, $n{=}5$). Small markers: synthetic patients ($N{=}100$ per
condition). With only 3 PCOS and 5 PE patients, the subgroups do not form
