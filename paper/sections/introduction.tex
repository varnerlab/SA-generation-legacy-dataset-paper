...
calibrated on real data. If this generalizes, the implication is that the
bottleneck for studying rare obstetric and pediatric conditions may be shifting
from cohort size toward cohort fidelity: a few dozen carefully phenotyped
