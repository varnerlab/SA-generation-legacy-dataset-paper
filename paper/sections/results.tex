...
splits. A single fixed split gave perfect separation, but that value sits at the top of the
split distribution rather than at its center, so we report the repeated-split mean throughout.}
...
matching both the leave-one-out distance among real patients and the distance from held-out
patients to the training set, whereas training members sat considerably closer. The attack
