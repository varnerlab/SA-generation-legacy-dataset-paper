...
Table~S11). Under TF+TM conditions, the model systematically overcorrected
the protein~C anticoagulant pathway, producing peak and maximum rate
predictions approximately 0.5$\times$ measured values for both real and
synthetic patients (Supplementary Fig.~S5, same layout as the main-text
comparison), yet this shared systematic bias was itself informative. Cloud overlap remained high (0.89--0.93 across the five
...
(Supplementary Fig.~S6), confirming that the calibrated rate constants
captured a stable
