...
All experiments used step size $\alpha = 0.05$, $T = 2{,}000$ Langevin iterations
per sample, and random seed 42 for reproducibility. The pipeline was implemented in
...
\For{$i = 1, \ldots, N$}
    \State Initialize $\hat{\vxi}_0 \sim \mathcal{N}(\mathbf{0}, \mathbf{I}_{18})$; normalize to unit norm
