...
$f_{\text{target}} = 0.80$ of softmax attention on the designated subset, via
...
correction. The pipeline was implemented in
Julia (v1.12) using the packages listed in the code repository.
