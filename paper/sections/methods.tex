...
listed in Supplementary Table~S2. For the PCOS subgroup
...
between the two samplers (Supplementary Table~\ref{tab:ula-vs-mala}). The
pipeline was implemented in Julia (v1.12) using the packages listed in the code
