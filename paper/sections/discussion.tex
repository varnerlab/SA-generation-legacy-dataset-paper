...
independent ODE model encoding decades of coagulation biochemistry, calibrated
...
generation~\citep{Varner2026SA}, transfers to clinical coagulation data. The entropy
...
diversity in the scale of generated samples.

Beyond these statistical and geometric considerations, the mechanistic validation
introduced a paradigm that we believe is broadly applicable
...
subgroup generation. These results confirmed that SA's advantage at small $n$ is not
merely theoretical: standard deep generative methods either fail outright (CTGAN) or
