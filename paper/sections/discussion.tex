...
\rboth{The clinical analysis also covered only one kind of record and one cohort size.}
...
work proportional to $TKd$ for each profile. The exact mixture sampler removed the $T$
sequential updates: its component weights could be prepared once, after which each profile
