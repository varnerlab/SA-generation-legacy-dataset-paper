...
UNMARKED / CLEAN MANUSCRIPT PDF
  File: Varner-Manuscript-Clean-v2.1.pdf in the repository root
  ...
  The clean manuscript has no highlights, tracked changes, or colored
  reviewer text.

MARKED MANUSCRIPT
  File: Varner-Manuscript-Marked-v2.1.pdf in the repository root
...
README
  File: README.txt in the repository root
  SNAPP category: RELATED FILES
...
SUPPLEMENTARY INFORMATION
  File: Varner-Supplementary-Information-v2.1.pdf in the repository root
